    ...
    <div className="bg-white relative overflow-hidden">
      ...
      >
        <div className="max-w-2xl mx-auto lg:max-w-none">
          ...
          <a
            href="#"
            className="mt-6 inline-block w-full rounded-md py-3 px-8 font-medium border-2 border-black text-black hover:bg-black hover:text-white 
            duration-500 sm:w-auto"
          >
